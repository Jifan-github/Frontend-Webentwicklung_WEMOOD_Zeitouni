...
<template>
  <Motion
      tag="span"
      :class="cn('rotating-text-wrapper', mainClassName)"
      v-bind="$attrs"
      :transition="transition"
      layout
  >
    ...
    <AnimatePresence :mode="animatePresenceMode" :initial="animatePresenceInitial">
      <Motion
          ...
          tag="span"
          :class="cn('rotating-text-inner', splitBy === 'lines' ? 'flex-col w-full' : '')"
          aria-hidden="true"
          layout
      >
        <span v-for="(wordObj, wordIndex) in elements" :key="wordIndex" :class="cn('rotating-text-word', splitLevelClassName)">
          <Motion
